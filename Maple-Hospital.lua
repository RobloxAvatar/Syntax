...
function hacked()
    for i = 1,120 do
        ...
        if timer == 0 then
            wait(1)
            local ohString1 = "BOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOMMMMMMMMMMM!"
            local ohInstance2 = getDayCareWhiteBoard()
            game:GetService("ReplicatedStorage").Whiteboard:FireServer(ohString1, ohInstance2)
        end
        local ohString1 = "SELF DESTRUCT IN: " .. timer .. " SECONDS!"
        local ohInstance2 = getDayCareWhiteBoard()
        game:GetService("ReplicatedStorage").Whiteboard:FireServer(ohString1, ohInstance2)
        wait(1)
    end
...
do
	...
	do
        ...
        MainTab:AddButton("Show on daycare board hacked[Nurse]", function()
	        hacked()
        end)

		MainTab:AddTextBox("Show Text On DayCare Board[Nurse]", function(txt)
	        local ohString1 = txt
            local ohInstance2 = getDayCareWhiteBoard()
            game:GetService("ReplicatedStorage").Whiteboard:FireServer(ohString1, ohInstance2)
        end)
